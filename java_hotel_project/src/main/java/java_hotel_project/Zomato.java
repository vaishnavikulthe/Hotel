...
import java_hotel_project.driver.ZomatoDriver;
...
public class Zomato {
	...
	public static void admin() {
		...
		int choice;
		do {
			System.out.println("1.add food    2.add hotel   3.exit");
	...
	public static void customer() {
		...
		int choice = 1000;
		while (choice != 0) {
			System.out.println("1.Add item    2.remove Item    3.showBill    4.order   5.exit");
			choice = Integer.parseInt(sc.nextLine());
			if (choice == 1)
				customer.addItem();
			if (choice == 2)
